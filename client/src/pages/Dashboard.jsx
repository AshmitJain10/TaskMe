        ...
        <div className="flex">
          {task.team.map((m, index) => (
            <div
              key={index}
              className={clsx(
                "w-7 h-7 items-center justify-center text-white rounded-full flex text-sm -mr-1",
...
const UserTable = ({ users }) => {
  ...
  return (
    <div className="w-full md:w-1/3 bg-white h-fit md:px-6 py-4 shadow-md rounded">
